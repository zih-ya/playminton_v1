...
const PastEventPage = () => {
  ...
  return (
    <div>
      ...
      <Wrapper>
        {isLoading ? (
          <Typography.Text style={{ marginLeft: 45 }}>
            Loading...
          </Typography.Text>
        ) : (
          <>
            {datas.map((data, i) => {
              return (
                ...
                >
                  ...
                  <p style={{ color: "gray" }}>
                    Time: {combine_time(data.startTime, data.endTime)}
                  </p>
                  ...
                  >
                    <p style={{ marginRight: "5px", color: "gray" }}>
                      Participants:
                    </p>
                    {data.participants.map((participant, j) => (
                      <p key={j} style={{ marginRight: "5px", color: "gray" }}>
                  ...
                  <Typography.Text mark>The event has closed.</Typography.Text>
                </Card>
              );
            })}
          </>
